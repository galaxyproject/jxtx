        ...
        <main className={compStyles.main}>
            ...
            <Section type={SectionType.HERO_DUO}>
                <GridItem gridArea={GridArea.BLOCK}>
                    <ContentBlock scale={ContentBlockScale.LARGE} theme={ContentBlockTheme.OFF_WHITE}>
                        <ContentBlockHeading scale={HeadingScale.LARGE} theme={HeadingTheme.ORANGE}>
                            Make a Pledge
                        </ContentBlockHeading>
                        <ContentBlockBody scale={ContentBlockBodyScale.MEDIUM}>
                            <form className="contactform" name="pledge" method="POST" data-netlify="true">
                                ...
                                <p>
                                    <label>
                                        Pledge: <input name="pledge" placeholder="$10.00" /> <sub>(optional)</sub>
                                    </label>
                                </p>
                                <p>
                            ...
                            <sub>
                                We will only use your contact information to notify you when the JXTX Foundation is able
                                to directly accept donations. Any pledge amount is appreciated, but note that pledges
                                are not binding.
                            </sub>
                        </ContentBlockBody>
                    </ContentBlock>
