...
function Button(props) {
    ...
    const {buttonAction, buttonScale, buttonTheme, buttonType, children} = props;
    ...
    const classNamesButton = classNames(compStyles.button, compStyles[classButtonScale], compStyles[classButtonTheme], compStyles[classButtonType]);
